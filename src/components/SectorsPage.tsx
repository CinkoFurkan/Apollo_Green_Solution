...
import { Sun, Building2, Factory, TrendingUp, Zap, BarChart3 } from 'lucide-react';
  ...
  const sectors = [
    {
      title: 'Renewables',
      icon: Sun,
      description: 'Optimize renewable energy generation and distribution with AI-powered forecasting and grid integration solutions.',
      features: [
    ...
    },
    {
      title: 'Real Estate',
      icon: Building2,
      description: 'Transform buildings into smart, energy-efficient spaces with comprehensive monitoring and optimization.',
      features: [
    ...
    },
    {
      title: 'Manufacturing',
      icon: Factory,
      description: 'Maximize production efficiency and minimize energy costs with intelligent load management and optimization.',
      features: [
  ...
  const benefits = [
    {
      ...
      description: 'Reduce energy costs by up to 30% with intelligent optimization',
    },
    {
      icon: Zap,
            ...
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="hexagons" width="50" height="43.4" patternUnits="userSpaceOnUse" patternTransform="scale(2)">
                  <polygon points="25,0 50,14.43 50,28.87 25,43.3 0,28.87 0,14.43" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5"/>
                </pattern>
              </defs>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Tailored energy solutions for diverse industries, powered by AI and precision engineering.
            </p>
          </motion.div>
        </div>
              ...
              >
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${
                  ...
                  <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                    <div className={`inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r ${sector.gradient} text-white mb-6`}>
                      <sector.icon className="w-5 h-5" />
                      <span>{sector.title}</span>
                    </div>
                    <h2 className="mb-4 text-[rgb(1,12,177)]">{sector.title} Solutions</h2>
                  ...
                  <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                    ...
                    >
                      ...
                      />
                      <div className={`absolute inset-0 bg-gradient-to-t ${sector.gradient} opacity-20`}></div>
                    </motion.div>
                  </div>
                </div>
              </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="mb-6 text-[rgb(1,12,177)]">Ready to Optimize Your Sector?</h2>
